...
<html>
  ...
  <body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc3-1" data-genuitec-path="/MyLogin/WebRoot/application.jsp">
  <h1 data-genuitec-lp-enabled="false" data-genuitec-file-id="wc3-1" data-genuitec-path="/MyLogin/WebRoot/application.jsp">application内置对象</h1>
  <%
		application.setAttribute("city", "杭州");
		application.setAttribute("postcode", "10000");
		application.setAttribute("email", "329757823qq.com");
   %>
